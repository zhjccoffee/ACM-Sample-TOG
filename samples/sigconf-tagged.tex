%%
%% This is file `sigconf-tagged.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% samples.dtx  (with options: `all,proceedings,sigconf,tagged')
%% 
%% IMPORTANT NOTICE:
%% 
...
%% with new filenames distinct from sigconf-tagged.tex.
%% 
...
\begin{teaserfigure}
 ...
 alt={Enjoying the baseball game from the third-base
  seats. Ichiro Suzuki preparing to bat.}]{sampleteaser}
...
\begin{figure}[h]
 ...
 alt={A woman and a girl in white dresses sit in
 an open car.}]{sample-franklin}
...
\begin{verbatim}
  \begin{teaserfigure}
 \includegraphics[width=\textwidth,
 alt={figure description}]{sampleteaser}
...
\endinput
%%
%% End of file `sigconf-tagged.tex'.
