%%
%% This is file `acmtog-conf.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% samples.dtx  (with options: `all,proceedings,acmtog,conf')
%% 
%% IMPORTANT NOTICE:
%% 
...
%% with new filenames distinct from acmtog-conf.tex.
%% 
