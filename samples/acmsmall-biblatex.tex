%%
%% This is file `acmsmall-biblatex.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% samples.dtx  (with options: `all,acmsmall,biblatex')
%% 
%% IMPORTANT NOTICE:
%% 
...
%% with new filenames distinct from acmsmall-biblatex.tex.
%% 
...
\endinput
%%
%% End of file `acmsmall-biblatex.tex'.
