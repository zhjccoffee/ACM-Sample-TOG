%%
%% This is file `acmsmall-tagged.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% samples.dtx  (with options: `all,acmsmall,tagged')
%% 
%% IMPORTANT NOTICE:
%% 
...
%% with new filenames distinct from acmsmall-tagged.tex.
%% 
...
\endinput
%%
%% End of file `acmsmall-tagged.tex'.
